...
public class RingProgressBar extends View {
    ...
    public RingProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        //获取自定义属性和默认值
        max = mTypedArray.getInteger(R.styleable.RingProgressBar_rMax, 10000);//进度最大值
        textColor = mTypedArray.getColor(R.styleable.RingProgressBar_rTextColor, Color.BLUE);//字体颜色
        textSize = mTypedArray.getDimension(R.styleable.RingProgressBar_rTextSize, 100);//字体大小
        ...
        progressColor = mTypedArray.getColor(R.styleable.RingProgressBar_rProgressColor, Color.GREEN);//外层进度环的颜色，默认蓝色
